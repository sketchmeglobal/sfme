                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select name="supplier_payment_terms" id="supplier_payment_terms" class="form-control round-input select2">
                                            ...
                                            <option value="<?=$supplier_payment_term->pt_id?>" <?=($offer_details[0]->supplier_payment_terms == $supplier_payment_term->pt_id)?'selected':''?>><?=$supplier_payment_term->payment_terms?></option>
