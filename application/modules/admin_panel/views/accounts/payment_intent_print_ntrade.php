        ...
        <section class="sheet padding-10mm" style="height:auto">
            ...
            <div class="row">
                <div class="col-4 border">
                    <p><b>Invoice No.: </b><?= $all_bills[0]->invoice_no?></p>
                    <p><b>Invoice Date:</b> <?=date('d-m-Y', strtotime($all_bills[0]->invoice_date))?> </p>
                </div>
                <div class="col-4 border">
                    <p><b>Total Amount: </b> <?=$all_bills[0]->total_payable?></p>
                    <p><b>Payment Status: </b> <?=($all_bills[0]->payment_approval_status == 1) ? 'Completed' : 'Ongoing'?></p>
                </div>
                <div class="col-4 border">
                    <p><b>Vendor:</b> <?=$all_bills[0]->name?> </p>
